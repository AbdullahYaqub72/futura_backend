        ...
        <div class="w-1/2 h-screen flex justify-center items-center">
            <div class="w-[60%] flex flex-col space-y-[3rem]">
                <div class="flex flex-col space-y-[1rem]">
                    <text class='text-2xl font-bold'>User Registration</text>
                    <text class='text-sm text-[#AAADB4]'>Already Registered? <a class="text-[#6578F9]">Login Here</a></text>
                </div>
                <div class="w-full flex flex-col space-y-6">
                    ...
                    <div class="w-full flex items-center space-x-2">
                        ...
                        <span class="text-[#AAADB4] text-sm whitespace-nowrap">or Register with Email</span>
                        <div class="flex-1 h-[1px] bg-[#AAADB4]"></div>
                    </div>
                </div>
